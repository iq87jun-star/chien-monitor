...
//   dist/pokeca-kaigai-checker-<version>.zip                 … Chrome ウェブストア・Edge アドオン用(同じzip)
//   dist/firefox/pokeca-kaigai-checker-<version>-firefox.zip … Firefox アドオン(AMO)用
...
const NAME = "pokeca-kaigai-checker";
const GECKO_ID = "toreca-checker@pokeca-kaigai.com";
