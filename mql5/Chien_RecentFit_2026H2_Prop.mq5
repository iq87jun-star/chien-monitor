...
input string InpMonLegs  = "GBPJPY:0.348,AUDJPY:0.299"; // Mon: 月曜o2o LONG
input string InpV4Legs   = "USDJPY:0.283";              // v4: 日足k≥4合議
input string InpHoldLegs = "JP225:0.070";               // Hold: 連続LONG
input double InpMult     = 4.8;    // リスク倍率(標準4.8 / 速攻7.2=.set)
...
input long   InpMagicBase = 943100;  // Mon=+1/v4=+2/Hold=+3
