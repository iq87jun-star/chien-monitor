//+------------------------------------------------------------------+
//| ★FTMO50k D案トラック 口座521100397 2026-09月次再スクリーニング版v2   |
//|  (docs/184訂正・2026-09-02) — 初版はclipデフォルト引数バグにより     |
//|  8月データ欠落窓で選抜されていたため本版で置換(バグ詳細はdocs/184)   |
//|  正選抜(..2026-08-31凍結): Mon USDJPY 32.0/EURJPY 27.7 +           |
//|   v4 GBPJPY 30.3 + Hold GER40 9.9 / 倍率5.24                       |
//|  MC(FTMO10/5): 選抜窓100% / 12ヶ月59.3% / 全期間62.7%              |
//|  (初版の12ヶ月9.5%警告はバグ起因の誤り — 正窓では正常水準)           |
//|  期限2026.09.30・ロック9.9/10.05・Magic 943400維持(建玉引継ぎ)      |
...
input string InpMonLegs  = "USDJPY:0.320,EURJPY:0.277"; // Mon: 月曜o2o LONG
input string InpV4Legs   = "GBPJPY:0.303";              // v4: 日足k≥4合議
input string InpHoldLegs = "GER40:0.099";               // Hold: 連続LONG
input double InpMult     = 5.24;   // リスク倍率(2026-09正窓の校正値)
...
input string InpMonSpreadCaps = "USDJPY:2.0,EURJPY:2.5"; // ペア別上限
...
input long   InpMagicBase = 943400;  // Mon=+1/v4=+2/Hold=+3(D系列維持=建玉引継ぎ)
