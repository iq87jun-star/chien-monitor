...
#property strict
#property description "[FN100k #14074882 P1-FINISH 3x] Portfolio-D ONE-CLICK (PROP median-3 standard): v4+v7+E-Mon[RG3]+E5=30:25:25:20. Drop on chart & OK. v1.10 profit lock+risk guard+swap log / v1.20 push notify (Even G2)+persistent baseline+E5 re-enter (docs/112) / v1.30 month-trail lock T2 (docs/116, default OFF)."
...
input double InpWeeklyRiskPct    = 1.15;  // v7 週次リスク%
input double InpV4RiskPerTradePct= 0.34;  // v4 1トレードあたりリスク%
input double InpEMonWeeklyPct    = 1.15;  // E-Mon 週次リスク%
input double InpE5LegRiskPct     = 0.92;  // E5 legRisk%(各レッグ月次σ)
