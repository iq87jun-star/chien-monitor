...
input string InpMonLegs  = "GBPJPY:0.13,EURJPY:0.133,AUDJPY:0.108,USDJPY:0.129"; // Mon: 月曜o2o LONG
input string InpV4Legs   = "";                          // v4: 未使用
input string InpHoldLegs = "";                          // Hold: 未使用(スワップ有り口座)
input double InpMult     = 3.3;   // Mon スリーブ倍率(docs/239)
...
input long   InpMagicBase = 944100;  // Mon=+1/v4=+2/Hold=+3/Sess=+5(既存EAと衝突しない基底)
