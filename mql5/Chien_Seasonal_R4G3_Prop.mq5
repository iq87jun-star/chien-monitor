...
#property version   "1.20"   // = Seasonal_Top_EA v1.50 相当
#property strict
#property description "R4+G3 ONE-CLICK (median-3, 1.5x, guards+notify+width built-in). Drop on chart & OK. Demo-first (docs/110-112)."
