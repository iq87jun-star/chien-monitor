...
#property strict
#property description "R4+G3 ONE-CLICK (median-3, 1.5x, guards+notify+width built-in, v1.40 dual-path lot sizing sanity / v1.41 no-roll-on-restart fix, docs/153). Drop on chart & OK. Demo-first (docs/110-112)."
