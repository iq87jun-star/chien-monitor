...
//+------------------------------------------------------------------+
//| ★Fintokei パール 500万 EA4: Sess 8本(上位5 + USDCHF16-20/NZDUSD16-20/CHFJPY20-00)|
//|   docs/238-239。逆ボラ加重・4.8倍(校正上限)。Mon/v4/Hold 無し                    |
//|   紙上(3pip): 年率+12.5%・最大DD−2.0%・最悪月−1.0%・MC 94〜98%/0%              |
//|   (2pip): 年率+26.8%・最大DD−1.1%。コスト1本の関数(docs/235 §3)                |
//|   Fintokei: 指標・週末制約なし(docs/185)。日次−4%・フロア−9%・ロック 7.9/8.05         |
//|   Magic 944300(既存 B案 943100 と別)。期限 2027-03-31                     |
//|   FOMC 決定日は建てない(InpSessSkipDates)。建てスプレッド上限 1.5pip                |
//+------------------------------------------------------------------+
#property copyright "chien-monitor research"
#property version   "1.12"   // docs/238-239: 2スリーブ汎用版(Mon/v4/Hold + Sess・FOMC日スキップ)
#property strict
...
input string InpMonLegs  = "";                             // Mon: 月曜o2o LONG
input string InpV4Legs   = "";                          // v4: 未使用
input string InpHoldLegs = "";                          // Hold: 未使用(スワップ有り口座)
input double InpMult     = 1.0;   // Mon スリーブ倍率(docs/239)
...
input long   InpMagicBase = 944300;  // Mon=+1/v4=+2/Hold=+3/Sess=+5(既存EAと衝突しない基底)
