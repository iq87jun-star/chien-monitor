...
#property strict
#property description "DROP-IN AllInOne for PROP breakthrough (FundedNext). Default=Prop 2.5x/65:35. v7+E5 all-in-one, auto-balance, auto-symbol. E5=LEAD/demo."
...
input ENUM_PORT_SCENARIO InpScenario = PORT_PROP_BREAKTHROUGH; // ★既定=プロップ突破(このEAは乗せるだけ)
