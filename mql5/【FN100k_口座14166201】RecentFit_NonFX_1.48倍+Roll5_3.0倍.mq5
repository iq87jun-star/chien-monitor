//| ★v1.30(2026-09-25): v1.10 の Sess レグ(docs/249 で無効)を EA7 v1.20 の Roll レグに置換。非FX ×1.48 + ロール ×3(docs/275: 5 年 年率 11.3%・FN 資金化 62%)。swap-free 口座(FN 書面 docs/185 §10b-3)専用。
//+------------------------------------------------------------------+
