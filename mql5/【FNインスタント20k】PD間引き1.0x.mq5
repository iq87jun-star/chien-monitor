...
#property version   "1.33"   // = v1.32 + インスタント適合(トレーリング/目標なし/1.0x)
#property strict
...
input double InpWeeklyRiskPct    = 0.38;  // v7 週次リスク%(研究1.0x, docs/162)
input double InpV4RiskPerTradePct= 0.11;  // v4 1トレードあたりリスク%(研究1.0x)
input double InpEMonWeeklyPct    = 0.38;  // E-Mon 週次リスク%(研究1.0x)
input double InpE5LegRiskPct     = 0.61;  // E5 legRisk%(研究1.0x)
...
input long   InpMagicBase = 760920;       // v7=+1 / v4=+2 / E5=+3 / E-Mon=+4(インスタント専用基底)
