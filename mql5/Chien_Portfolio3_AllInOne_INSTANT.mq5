//+------------------------------------------------------------------+
//|                    Chien_Portfolio3_AllInOne_INSTANT.mq5          |
//|   3戦略オールインワン(インスタント既定): v7(円月曜) + v4(日足k≥4   |
...
#property strict
#property description "3-strategy all-in-one (INSTANT default): v7(JPY Monday)+v4(daily k>=4 confluence)+E5(multi-asset trend) on one chart. Per-strategy magics. E5=LEAD/demo."
...
input ENUM_PORT3_SCENARIO InpScenario = PORT_INSTANT; // ★本ファイル既定=インスタント
