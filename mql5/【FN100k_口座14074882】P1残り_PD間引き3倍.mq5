//+------------------------------------------------------------------+
//|          【FN100k 口座14074882】P1残り・PD間引き版 3倍            |
...
input double InpWeeklyRiskPct    = 1.09;  // v7 週次リスク%
input double InpV4RiskPerTradePct= 0.32;  // v4 1トレードあたりリスク%
input double InpEMonWeeklyPct    = 1.09;  // E-Mon 週次リスク%
