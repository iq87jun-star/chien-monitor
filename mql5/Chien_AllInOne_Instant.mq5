...
#property strict
#property description "DROP-IN AllInOne for INSTANT (Blueberry). Default=Instant 1.5x/75:25. v7+E5 all-in-one, auto-balance, auto-symbol. E5=LEAD/demo."
...
input ENUM_PORT_SCENARIO InpScenario = PORT_INSTANT; // ★既定=インスタント(このEAは乗せるだけ)
