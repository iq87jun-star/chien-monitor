//+------------------------------------------------------------------+
//| ★FTMO50k D案トラック 口座521100397 2026-09版【規則適合・改訂】       |
//|  (docs/196・2026-09-01ユーザー決定「規則適合構成へ差し替え」)       |
//|  ⚠ 旧『RecentFit_D3m_202609_5.0倍』を置換。旧版は docs/192 の      |
//|    clip()窓truncateバグにより、宣言窓 2026-06-01..08-31 に対し     |
//|    実際は ..2026-07-29(約2ヶ月)で選抜されていた=規則不適合。       |
//|  選抜(docs/180 §2の規則を不変のまま正しい3ヶ月窓で再実行):          |
//|   Mon USDJPY 32.1% / Mon EURJPY 27.7%                              |
//|   v4  GBPJPY 30.3% / Hold GER40 9.9%                               |
//|   ※TSMOM族は選抜されず=除外・再正規化は不要(旧版と異なる)          |
//|   ※3桁丸めの合計調整 +0.001 を Mon USDJPY へ(Σw=1.000・docs/196)   |
//|  倍率5.24(0.8×min(m*_sel8.00, m*_12m6.55)・cap6.0)                 |
//|  MC(FTMO10/5): 選抜窓100.0% / 12ヶ月59.3%(失格13.2%)               |
//|                / 全期間62.7%(失格31.3%)                            |
//|   → 旧版の12ヶ月9.5%(失格52.8%)はバグの産物。docs/192 §3-4参照     |
//|  期限2026.09.30(毎月再スクリーニング)・ロック9.9/10.05(FTMO P1+10%) |
//|  P2移行時: LockArm=4.9/LockClose=5.05/ProfitStop=5.1/BaselineReset  |
//|  Magic 943400維持(旧D構成の残存建玉を本EAが時間決済で引き継ぎ管理)   |
