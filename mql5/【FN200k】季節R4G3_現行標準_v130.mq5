...
#property strict
#property description "[FN200k R4G3 standard v1.30] R4+G3 ONE-CLICK (median-3, 1.5x, guards+notify+width built-in). Drop on chart & OK. Demo-first (docs/110-112)."
...
input double InpInitialBalance    = 200000.0;  // 0=自動(初回アタッチ時の残高を端末に永続保存・再アタッチ耐性)
