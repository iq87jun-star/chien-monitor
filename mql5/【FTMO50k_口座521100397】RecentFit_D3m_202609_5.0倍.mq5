//+------------------------------------------------------------------+
//| ★FTMO50k D案トラック 口座521100397 2026-09月次再スクリーニング版      |
//|  (docs/184・2026-09-01ユーザー決定「配備で」・旧D3m 5.52倍版を置換)   |
//|  選抜(docs/180 §2窓ロール・..2026-08-31凍結):                       |
//|   Mon USDJPY 45.9% / v4 GBPJPY 45.8% / Hold GER40 8.3%             |
//|   ※TSMOM_BTCUSD 3.6%はEA未実装のため除外・再正規化(docs/178 §2前例) |
//|  倍率5.0(0.8×min(m*_sel8.00, m*_12m6.25)・cap6.0)                  |
//|  MC(FTMO10/5): 選抜窓98.4% / 12ヶ月9.5%⚠ / 全期間54.7%             |
//|  ⚠12ヶ月バウンド9.5%は旧構成配備時(62.2%)から大幅劣化 — 6-8月の     |
//|    静穏窓によるノイズ選抜の懸念を承知の上での配備(docs/184)          |
...
input string InpMonLegs  = "USDJPY:0.459";              // Mon: 月曜o2o LONG
input string InpV4Legs   = "GBPJPY:0.458";              // v4: 日足k≥4合議
input string InpHoldLegs = "GER40:0.083";               // Hold: 連続LONG
input double InpMult     = 5.0;    // リスク倍率(2026-09再スクリーニング校正値)
...
input string InpMonSpreadCaps = "USDJPY:2.0";           // ペア別上限
