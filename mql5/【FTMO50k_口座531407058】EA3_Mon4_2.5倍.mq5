...
input bool   InpSessEnable        = false;
input string InpSessLegs          = ""; // SYM:方向:建てUTC時:保有h:重み
input double InpSessMult          = 2.5;   // Sess 専用倍率(名目=基準残高×重み×倍率)
...
input long   InpMagicBase = 944200;  // Mon=+1/v4=+2/Hold=+3/Sess=+5(既存EAと衝突しない基底)
