...
export const USER_AGENT =
  "gunpla-souba-monitor/0.1 (personal project; contact: iq87jun@gmail.com)";
...
export const NG_WORDS =
  /完成品|塗装済|組立済|素組み|ジャンク|パーツ取り|部品取り|パーツのみ|ランナー|デカールのみ|水転写|説明書のみ|箱のみ|空箱/;

// この価格未満の出品はノイズ(部品・雑貨等)とみなして除外する(円)
export const MIN_LISTING_JPY = 800;
