...
# -*- coding: utf-8 -*-
"""
mid価格ベースの再構築ポートフォリオ v2 (2026-07-24)
...
def main():
    ...
    for budget in [300000]:
        ...
        pd.DataFrame({'strategy': NAMES, 'v2_opt30': st.astype(int), 'v2_robust': st2.astype(int)}
                     ).to_csv(SP / 'alloc_v2.csv', index=False, encoding='utf-8-sig')
