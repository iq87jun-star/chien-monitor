...
// ダークプラム×ローズゴールド配色。夜のコスメカウンターの雰囲気
const T = {
  bg: "#181014",
  surface: "#20151C",
  surfaceVar: "#2A1C24",
    ...
    >
      ...
      >
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          ...
          <div style={{ fontSize: 12, color: T.textMed, marginTop: 4 }}>
            コフレ・限定コスメ・廃盤コスメの二次流通価格(楽天市場の出品を自動集計)
      ...
      >
        ...
        >
          ...
          メーカー公式の販売価格・買取価格ではありません。商品リンクにはアフィリエイトリンクを含みます。
          本サイトは化粧品の効果・効能についての情報を提供するものではなく、転売や投資の助言でもありません。
          本サイトは各ブランド・楽天グループと無関係の個人運営サイトであり、過去に同ドメインで運営されていた
          芸能プロダクション「COSME PRESS」および「コスメプレス」名称の他サイトとも一切関係ありません。
