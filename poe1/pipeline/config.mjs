...
export const USER_AGENT =
  "poe1-jp-meta-monitor/0.1 (personal project; contact: iq87jun@gmail.com)";

export const NINJA_BASE = "https://poe.ninja/poe1/api/economy";
...
// Path of Exile のSteam AppID(Steam News API用)
export const STEAM_APPID = 238960;
