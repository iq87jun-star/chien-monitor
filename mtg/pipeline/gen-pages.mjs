...
export const SITE_URL = "https://mtg-kaigai.com/";
...
function articleHtml(a) {
  ...
  const jsonLd = {
    ...
    author: { "@type": "Organization", name: "MTG海外相場モニター" },
...
<title>${esc(a.title)} | MTG海外相場モニター</title>
...
<meta property="og:site_name" content="MTG海外相場モニター">
<meta name="twitter:card" content="summary_large_image">
<script type="application/ld+json">${JSON.stringify(jsonLd)}</script>
<style>
  body{margin:0;background:#12100C;color:#EAE7DE;font-family:'Hiragino Sans','Noto Sans JP','Yu Gothic',system-ui,sans-serif;line-height:1.85}
  .wrap{max-width:760px;margin:0 auto;padding:24px 18px 60px}
  a{color:#E8B06A}
  .home{font-size:13px;color:#ADA795;text-decoration:none}
  .badge{display:inline-block;font-size:11px;font-weight:700;color:#12100C;background:#E8B06A;border-radius:999px;padding:2px 10px;margin-right:8px}
  .date{font-size:12px;color:#736C58}
  h1{font-size:24px;line-height:1.5;margin:14px 0 10px;color:#fff}
  .lead{color:#ADA795;font-size:15px;border-left:3px solid #D08A3E;padding-left:12px;margin:16px 0 26px}
  h2{font-size:18px;color:#E8B06A;margin:30px 0 8px;border-bottom:1px solid #3A3322;padding-bottom:6px}
  p{margin:10px 0;font-size:15px;white-space:pre-wrap}
  .tags{margin-top:26px}
  .tag{display:inline-block;font-size:12px;color:#ADA795;background:#1F1B13;border:1px solid #3A3322;border-radius:999px;padding:3px 12px;margin:0 6px 6px 0}
  .cta{margin-top:30px;background:#181510;border:1px solid #3A3322;border-radius:14px;padding:16px 18px;font-size:14px}
  footer{margin-top:36px;border-top:1px solid #3A3322;padding-top:14px;font-size:11px;color:#736C58;line-height:1.8}
</style>
</head>
<body>
<div class="wrap">
  <a class="home" href="../../">← MTG海外相場モニター トップ</a>
  ...
  <div class="cta">📊 最新の高騰・下落ランキングと全記事は
    <a href="../../">MTG海外相場モニター</a> で毎日自動更新中(TCGplayer価格×円換算)</div>
  <footer>本記事は集計データからAIが自動生成し、数値の照合チェックを通過したものです。
  価格はTCGplayer(米国)のドル建て価格と円換算の参考値であり、日本国内のショップ価格ではありません。
  売買・投資の助言ではありません。本サイトはWizards of the Coast・TCGplayer・Scryfallと無関係の非公式ファンサイトです。</footer>
</div>
</body>
</html>`;
}
