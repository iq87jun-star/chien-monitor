...
// ダークネイビー×エレクトリックイエロー配色。ピカチュウ×深夜の対戦卓の雰囲気
const T = {
  bg: "#0E1420",
  surface: "#151D2E",
  surfaceVar: "#1B2740",
    ...
    >
      ...
      >
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          ...
          <div style={{ fontSize: 12, color: T.textMed, marginTop: 4 }}>
            ポケカ未開封BOX・高額シングルの国内相場(楽天市場の出品を自動集計)
      ...
      >
        ...
        >
          ...
          転売や投資の助言ではありません。海外相場は姉妹サイト
          <a href="https://pokeca-kaigai.com/" style={{ color: T.textMed }}>
            ポケカ海外相場モニター
          </a>
          をご覧ください。
          本サイトは株式会社ポケモン・任天堂・クリーチャーズ・ゲームフリーク・楽天グループと無関係の
          非公式ファンサイトであり、過去に同ドメインで運営されていたブログ「ポケカミン」とも無関係です。
