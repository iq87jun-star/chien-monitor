...
#property strict
#property description "[RecentFit NonFX2 FN100k 14074882 v1.03] CHALLENGE calibration: mult 2.5, profit lock ON (P1 7.9/8.05/8.1)."
#property description "P1 pass 64.3% / bust 26.9% / median 78 trading days (conservative series, 20k paths). Revert to mult 0.90 once funded."
...
int OnInit()
{
   ...
   Print("[NOTE] チャレンジ校正 mult2.5: P1+8%到達64%/失格27%/中央値78営日(保守系列)。資金化後は0.90へ。");
...
void OnTimer()
{
   ...
   Comment(StringFormat("FN14074882_RF_NonFX2 v1.03 | gain %+.2f%% | mult %.2f | %s",gainPct,InpMult,
