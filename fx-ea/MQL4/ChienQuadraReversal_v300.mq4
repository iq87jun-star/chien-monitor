...
#define EA_BUILD "QuadraReversal v3.00-FIXED (MT4)"
...
const double FIX_RISK_PERCENT = 1.0;
...
double CalcLots(const double slDistance)
  {
   ...
   double lots = AccountBalance() * FIX_RISK_PERCENT / 100.0 / lossPerLot;
